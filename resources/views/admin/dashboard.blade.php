        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    <div class="mb-4">
                        <form method="GET" action="{{ route('dashboard') }}" class="flex gap-2">
                            <input type="text" 
                                   ...
                                   class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm">
                            <button type="submit" 
                                    class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-300 text-sm">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-200 mb-3">{{ $weatherData['name'] ?? $city }}</h3>
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <p class="text-3xl font-bold text-gray-800 dark:text-gray-200">{{ $weatherData['main']['temp_celsius'] ?? 0 }}°C</p>
                        ...
                        <div class="grid grid-cols-3 gap-2 text-xs">
                            <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                                ...
                                <p class="text-gray-600 dark:text-gray-400">{{ $weatherData['main']['humidity'] }}%</p>
                            </div>
                            <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                                <i class="bi bi-wind text-blue-500"></i>
                                <p class="text-gray-600 dark:text-gray-400">{{ $weatherData['wind']['speed_kmh'] }} km/h</p>
                            </div>
                            <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                                <i class="bi bi-thermometer-half text-blue-500"></i>
                                <p class="text-gray-600 dark:text-gray-400">{{ $weatherData['main']['feels_like_celsius'] }}°C</p>
                            </div>
                        </div>
                    </div>
                    @else
                    <div class="text-center py-4">
                        <i class="bi bi-cloud text-3xl text-gray-400 mb-2"></i>
                        <p class="text-sm text-gray-600 dark:text-gray-400">No weather data</p>
                    </div>
                    @endif
                </div>
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        ...
                        @endforelse
                        <a href="{{ route('admin.orders.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline block text-center mt-4">View All Orders →</a>
                    </div>
                </div>
            </div>
