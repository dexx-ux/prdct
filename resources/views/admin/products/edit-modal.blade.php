            ...
            <form id="editProductForm" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="image-upload-wrapper">
                        ...
                        <div class="image-upload-input">
                            <input type="file" id="edit_image" name="image" accept="image/*" 
                                   class="file-input" onchange="previewEditImage(this)">
                        ...
                        <div id="editImagePreview" class="image-preview-box">
                            <div class="preview-placeholder" id="editPlaceholder">
                                <i class="fas fa-image"></i>
                                <p>No image</p>
                            </div>
                            <img id="editPreviewImg" src="" alt="Preview" style="display: none;">
                        </div>
                    </div>
                </div>

                <!-- Current Image Info (shown if image exists) -->
                <div id="currentImageInfo" class="current-image-info" style="display: none;">
                    <i class="fas fa-info-circle"></i>
                    <span>Current image will be replaced when you upload a new one.</span>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div id="edit_price_error" class="error-message"></div>
                    </div>
                </div>
                ...
                <div class="info-box">
                    <i class="fas fa-info-circle"></i>
                    <small>Updating this product will affect all existing orders that reference it.</small>
                </div>
...
function openEditModal(productId) {
    ...
    const currentInfo = document.getElementById('currentImageInfo');
    ...
    if (previewBox) previewBox.style.borderColor = '#e5e7eb';
    ...
    // Show loading state
    const submitBtn = document.querySelector('#editProductModal .btn-submit');
    ...
    fetch(`/admin/products/${productId}/edit-data`)
        ...
        .then(data => {
            ...
            // Show current image info if image exists
            if (data.image) {
                if (currentInfo) currentInfo.style.display = 'flex';
                // Also show the current image in preview
...
function clearEditErrors() {
    document.querySelectorAll('#editProductForm .error-message').forEach(el => {
        el.textContent = '';
    });
    document.querySelectorAll('#editProductForm input, #editProductForm textarea, #editProductForm select').forEach(el => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (editForm) {
        editForm.addEventListener('submit', function(e) {
            ...
            const url = `/admin/products/${currentEditProductId}`;
