                        ...
                        <div class="p-6">
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <div class="mt-4 w-full">
                                    ...
                                    <button type="button" 
                                            onclick="openModal()" 
                                            class="mt-2 w-full px-4 py-2 border border-red-500 text-red-600 dark:text-[#1a2c3e] hover:bg-red-50 dark:hover:bg-red-900/20 text-sm rounded-md transition duration-200">
                                        Remove Picture
                                    </button>
